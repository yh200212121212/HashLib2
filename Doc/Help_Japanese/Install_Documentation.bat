...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale ja-jp /uninstall /silent /vendor "Vendor Name" /productName "This is the implementation of the hash algorithm I invented." /mediaBookList "This is the implementation of the hash algorithm I invented." > NUL
...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale ja-jp /sourceMedia "%CD%\HelpContentSetup.msha"
...
REM Uninstall first in case it is already there.  If not, it won't install below.  We'll ignore any error output
REM by redirecting it to NUL.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale ja-jp /wait 0 /operation uninstall /vendor "Vendor Name" /productName "This is the implementation of the hash algorithm I invented." /bookList "This is the implementation of the hash algorithm I invented." > NUL

REM Install the new content.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale ja-jp /wait 0 /operation install /sourceUri "%CD%\Documentation.msha"
